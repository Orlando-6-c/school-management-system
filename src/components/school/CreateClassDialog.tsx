        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-white text-gray-900">
                ...
                <form action={action} className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="annualFee" className="text-gray-700">Standard Annual Fee</Label>
                        <Input id="annualFee" name="annualFee" type="number" min="0" defaultValue="0" required className={inputClasses} />
                    </div>
