...
export default function AdmissionForm({ classes }: AdmissionFormProps) {
    ...
    // Effect: Auto-fill fee when class changes
    useEffect(() => {
    ...
    const handleCnicSearch = async () => {
        ...
        try {
            ...
            if (guardian) {
                ...
                // Guardian email might be missing in schema, handle safely if needed
                ...
                <Card className="bg-white shadow-sm border-gray-200">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <p className="text-xs text-gray-500">Selecting a class will auto-fill the monthly fee.</p>
                        </div>
                        <div className="grid gap-2">
