    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-gray-500 mt-2">Create and manage your school classes and fees.</p>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="lg:col-span-2 space-y-4">
                    {classes.length === 0 ? (
                        ...
                        classes.map((cls) => (
                            <Card key={cls.id} className="bg-white shadow-sm border-gray-200">
                                <CardContent className="p-4 flex items-center justify-between">
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500 mt-1">
                                            Fee: <span className="font-medium text-gray-900">{Number(cls.monthlyTuitionFee)}</span> / month
                                        </div>
